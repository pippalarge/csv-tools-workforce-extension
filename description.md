**CSV Tools** brings spreadsheet-style data handling into your Workforce flows.

Parse a CSV into structured rows, then filter, rename, clean, validate, deduplicate, batch, and summarise that data — and write it back out as CSV or JSON when you're done. Ideal for preparing product feeds, catalogue exports, or any tabular file before it's sent to an external system.
